...
class TestCachedMedia:
    def test_display_title_with_year(self):
        ...
        assert media.display_title == "Breaking Bad (2008)"
    ...
    def test_display_title_without_year(self):
        ...
        assert media.display_title == "Unknown Movie"
    ...
    def test_duration_formatted_hours_and_minutes(self):
        ...
        assert media.duration_formatted == "2h 0m"
    ...
    def test_duration_formatted_minutes_only(self):
        ...
        assert media.duration_formatted == "30m"
    ...
    def test_duration_formatted_none(self):
        ...
        assert media.duration_formatted is None
    ...
    def test_imdb_id_field(self):
        ...
        assert media.imdb_id == "tt1234567"
...
class TestActiveStream:
    ...
    def test_progress_formatted(self):
        ...
        assert stream.progress_formatted == "1:01:01 / 2:02:02"
    ...
    def test_state_emoji(self):
        ...
        assert stream.state_emoji == "⏸️"


class TestOverseerrSearchResult:
    ...
    def test_type_emoji(self):
        ...
        assert movie.type_emoji == "🎬"
        assert tv.type_emoji == "📺"
